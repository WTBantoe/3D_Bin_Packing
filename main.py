...
utils.log_utils.MyLogger().get_log_path(LOG_DIR, task_args, type_args, method_args, config_args)
...
data_path = os.path.abspath("../3d_Bin_Packing/test_data.txt")
...
if type_args.type == "online":
    ...
    for single_bin in bins:
        ...
        bin_place = container.search(single_bin, task_args.strict_level, method_args.method, config_args.bin_rotate, **config_args.__dict__)
